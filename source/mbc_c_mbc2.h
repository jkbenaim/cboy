...
void mbc_c_mbc2_write_bank_0( uint16_t address, uint8_t data );
void mbc_c_mbc2_write_bank_n( uint16_t address, uint8_t data );
...
void mbc_c_mbc2_write_ram_bank_select( uint16_t address, uint8_t data );
void mbc_c_mbc2_write_clock_data_latch( uint16_t address, uint8_t data );
